...
:: e) "http://portal.sample.com" with the name of the site you wish to publish to
...
%STSADM% -o deactivatefeature -filename %PROJECTNAME%\feature.xml -url http://portal.sample.com
...
%STSADM% -o activatefeature -filename %PROJECTNAME%\feature.xml -url http://portal.sample.com
...
%STSADM% -o deactivatefeature  -filename %PROJECTNAME%\feature.xml  -url http://portal.sample.com/  -force
...
%STSADM% -o installfeature     -filename %PROJECTNAME%\feature.xml  -force
%STSADM% -o activatefeature    -filename %PROJECTNAME%\feature.xml  -url http://portal.sample.com/  -force
